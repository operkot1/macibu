...
| `p4-zimes` | `/macos-braukt/zimes/` | `/uchus-vodit/znaki/` | справочник знаков | `ToolPageTemplate` | Ф4 | ★ | `traffic_signs` (частично — категории `priority` 201–209, `mandatory` 401–427, `service` 601–634, `prohibition` 301–334 и `warning` 101–143, 3 из 8 официальных категорий ещё впереди) | в проде (T-109, пятый срез) |
