...
| `p4-zimes` | `/macos-braukt/zimes/` | `/uchus-vodit/znaki/` | справочник знаков | `ToolPageTemplate` | Ф4 | ★ | `traffic_signs` (частично — категории `priority` 201–209 и `mandatory` 401–427, 6 из 8 официальных категорий ещё впереди) | в проде (T-109, второй срез) |
