...
| `p4-zimes` | `/macos-braukt/zimes/` | `/uchus-vodit/znaki/` | справочник знаков | `ToolPageTemplate` | Ф4 | ★ | `traffic_signs` (частично — категории `priority` 201–209, `mandatory` 401–427, `service` 601–634, `prohibition` 301–334, `warning` 101–143 и `direction` 16/53 подмножество virzienu rādītāji 701–753, 2 из 8 официальных категорий ещё впереди) | в проде (T-109, шестой срез) |
