...
| `p4-zimes` | `/macos-braukt/zimes/` | `/uchus-vodit/znaki/` | справочник знаков | `ToolPageTemplate` | Ф4 | ★ | `traffic_signs` (все 8 официальных категорий заполнены: `priority` 201–209, `mandatory` 401–427, `service` 601–634, `prohibition` 301–334, `warning` 101–143, `direction` 16/53 подмножество virzienu rādītāji 701–753, `information` 501–556 и `additional` 801–860 — обе последние полные) | в проде (T-109, восьмой срез, все категории закрыты) |
