...
- **Откуда:** `MK noteikumi Nr. 279 «Ceļu satiksmes noteikumi», Pielikums
  ...
  rādītāji, papildzīmes). Заполнены четыре категории: `"priority"` (знаки
  ...
  третий срез) и `"prohibition"` (знаки 301–334, «aizlieguma zīmes», 34
  из 34, T-109 четвёртый срез). Названия/значения всех категорий свёрены
  по двум независимым текстовым источникам (credoautoprieks.lv, gross.lv
  для 301–334, 401–427 и 601–634; дополнительно поисковый результат со
  ссылкой на likumi.lv для 201–209) — при любом расхождении между
  источниками или простом текстовом совпадении решающей проверкой был не
  текст, а прямой геометрический анализ координат официальной векторной
  графики и/или визуальный рендер (см. ниже). Остальные 4 категории —
  будущие срезы, каждый со своим планированием (по решению пользователя,
  docs/11-backlog.md T-109).
