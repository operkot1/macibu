...
- **Откуда:** `MK noteikumi Nr. 279 «Ceļu satiksmes noteikumi», Pielikums
  ...
  rādītāji, papildzīmes). Заполнены две категории: `"priority"` (знаки
  201–209, «priekšrocības zīmes», 9 из 9, T-109 первый срез) и
  `"mandatory"` (знаки 401–427, «rīkojuma zīmes», 27 из 27, T-109 второй
  срез). Названия/значения обеих категорий свёрены по двум независимым
  текстовым источникам (credoautoprieks.lv, gross.lv для 401–427;
  ...
  (см. ниже). Остальные 6 категорий — будущие срезы, каждый со своим
