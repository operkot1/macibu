...
- **Откуда:** `MK noteikumi Nr. 279 «Ceļu satiksmes noteikumi», Pielikums
  ...
  rādītāji, papildzīmes). Заполнены семь категорий: `"priority"` (знаки
  ...
  **единственная неполная категория**: 16 из 53 официальных номеров
  ...
  и `"information"` (знаки 501–556, «norādījuma zīmes», 56 из 56, T-109
  седьмой срез, полная категория). Названия/значения всех категорий
  свёрены по двум независимым текстовым источникам (credoautoprieks.lv,
  gross.lv для 101–143, 301–334, 401–427, 501–556 и 601–634;
  ...
  совпадении решающей проверкой был не текст, а прямой
  геометрический анализ координат официальной векторной графики и/или
  визуальный рендер (см. ниже). Осталась 1 категория (papildzīmes) —
  будущий срез, планирование по решению пользователя (docs/11-backlog.md
  T-109).
